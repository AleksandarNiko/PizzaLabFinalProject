...
namespace PizzaLab.Data.Migrations
{
    ...
    [Migration("20241209184145_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PizzaLab.Data.Models.Cart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PizzaLab.Data.Models.CartPizza", b =>
                {
            ...
            modelBuilder.Entity("PizzaLab.Data.Models.Dough", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PizzaLab.Data.Models.Menu", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PizzaLab.Data.Models.MenuPizza", b =>
                {
                    b.Property<int>("PizzaId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PizzaLab.Data.Models.Pizza", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PizzaLab.Data.Models.PizzaProduct", b =>
                {
                    b.Property<int?>("PizzaId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PizzaLab.Data.Models.Topping", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("PizzaLab.Data.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("PizzaLab.Data.Models.CartPizza", b =>
                {
                    b.HasOne("PizzaLab.Data.Models.Cart", "Cart")
                        .WithMany("CartsPizzas")
                        .HasForeignKey("CartId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PizzaLab.Data.Models.Pizza", "Pizza")
                        .WithMany("CartsPizzas")
            ...
            modelBuilder.Entity("PizzaLab.Data.Models.MenuPizza", b =>
                {
                    b.HasOne("PizzaLab.Data.Models.Menu", "Menu")
            ...
            modelBuilder.Entity("PizzaLab.Data.Models.Order", b =>
                {
                    b.HasOne("PizzaLab.Data.Models.ApplicationUser", "User")
                        .WithMany("Orders")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("PizzaLab.Data.Models.Pizza", b =>
                {
                    b.HasOne("PizzaLab.Data.Models.Dough", "Dough")
                        .WithMany("Pizzas")
            ...
            modelBuilder.Entity("PizzaTopping", b =>
                {
                    b.HasOne("PizzaLab.Data.Models.Pizza", null)
                        .WithMany()
                        .HasForeignKey("PizzasId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PizzaLab.Data.Models.Topping", null)
                        .WithMany()
